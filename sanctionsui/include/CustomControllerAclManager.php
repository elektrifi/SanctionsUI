<?php
    class CustomControllerAclManager extends Zend_Controller_Plugin_Abstract
    {
        ...
        public function __construct(Zend_Auth $auth)
        {
            ...
            $this->acl->add(new Zend_Acl_Resource('screening'));
            ...
            // allow members access to the screening area
            $this->acl->allow('member', 'screening');
            $this->acl->allow('member', 'screening', array(	'checkadhoc',
															'checkadhocresponse',            
            												'uploadfile'));
